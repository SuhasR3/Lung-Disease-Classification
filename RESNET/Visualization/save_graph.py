...
# List of files
files = {
    'Adadelta Baseline':    './baseline/resnet_baseline_adadelta.txt',
    'AdamW Baseline':       './baseline/resnet_baseline_adamw.txt',
    'SGD Baseline':         './baseline/resnet_baseline_sgd.txt',
    'Adadelta HP1':         './hyperparameters1/resnet_hp1_adadelta.txt',
    'AdamW HP1':            './hyperparameters1/resnet_hp1_adamw.txt',
    'SGD HP1':              './hyperparameters1/resnet_hp1_sgd.txt',
    'Adadelta HP2':         './hyperparameters2/resnet_hp2_adadelta.txt',
    'AdamW HP2':            './hyperparameters2/resnet_hp2_adamw.txt',
    'SGD HP2':              './hyperparameters2/resnet_hp2_sgd.txt',
    'Adadelta S':           './scheduler/resnet_scheduler_adadelta.txt',
    'AdamW S':              './scheduler/resnet_scheduler_adamw.txt',
    'SGD S':                './scheduler/resnet_scheduler_sgd.txt'
}
...
# # Customize the plot
# plt.title('Resnet-50 With Scheduler Loss', fontsize='20')
# plt.xlabel('Epoch')
# plt.ylabel('Loss')
...
# plt.ylim(0, 2)
# # Save the plot
# plt.savefig('./Visualization/resnet_scheduler_loss.png')
# plt.show()
...
# Customize the plot
plt.title('Resnet-50 Validation F1-Score Over Epochs')
plt.xlabel('Epoch')
plt.ylabel('F1 Score')
...
plt.ylim(0, 1)
# Save the plot
plt.savefig('./Visualization/resnet_f1_scores.png')
plt.show()
